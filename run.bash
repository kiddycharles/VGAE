...
python3 train.py --dataset citeseer --model VGAE6 --input_dim 3703 --num_class 6
python3 train.py --dataset citeseer --model VGAE7 --input_dim 3703 --num_class 6
python3 train.py --dataset citeseer --model VGAE8 --input_dim 3703 --num_class 6
python3 train.py --dataset citeseer --model VGAE9 --input_dim 3703 --num_class 6
python3 train.py --dataset citeseer --model VDGAE --input_dim 3703 --num_class 6
python3 train.py --dataset citeseer --model VGAE4v2 --input_dim 3703 --num_class 6
